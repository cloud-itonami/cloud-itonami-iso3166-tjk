(ns marketentry.store
  "SSoT for the Tajikistan market-entry compliance actor, behind a
  ...
  `:requires-business-registration?`/`:has-business-registration?`
  ground the Tax Committee Unified-state-register business-registration
  check; `:requires-tax-registration?`/`:tax-registration-verified?`
  ground the Tax Code (2012) tax-registration check;
  `:requires-investment-registration?`/
  `:investment-registration-verified?` ground the State Committee on
  Investments (Law No. 2173) foreign-investment check -- see
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems TJK" :portal "Agency on Public Procurement"
             ...
             :jurisdiction "TJK" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "Agency on Public Procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-business-registration? true :has-business-registration? true
             :requires-tax-registration? true :tax-registration-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "Agency on Public Procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "TJK" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "Agency on Public Procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-business-registration? true :has-business-registration? false
             :requires-tax-registration? true :tax-registration-verified? true
             :requires-investment-registration? true :investment-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "TJK" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "Agency on Public Procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-business-registration? true :has-business-registration? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "TJK" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "Agency on Public Procurement"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 6
             :claimed-fee 550000.0
             :requires-business-registration? true :has-business-registration? true
             :requires-tax-registration? true :tax-registration-verified? true
             :requires-investment-registration? true :investment-registration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "TJK" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               requires-investment-registration? investment-registration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-business-registration?)    (assoc :engagement/requires-business-registration? requires-business-registration?)
    (some? has-business-registration?)         (assoc :engagement/has-business-registration? has-business-registration?)
    ...
    (some? requires-investment-registration?)  (assoc :engagement/requires-investment-registration? requires-investment-registration?)
    (some? investment-registration-verified?)  (assoc :engagement/investment-registration-verified? investment-registration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-business-registration? :engagement/has-business-registration?
   :engagement/requires-tax-registration? :engagement/tax-registration-verified?
   :engagement/requires-investment-registration? :engagement/investment-registration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-business-registration? (boolean (:engagement/requires-business-registration? m))
     :has-business-registration? (boolean (:engagement/has-business-registration? m))
     ...
     :requires-investment-registration? (boolean (:engagement/requires-investment-registration? m))
     :investment-registration-verified? (boolean (:engagement/investment-registration-verified? m))
